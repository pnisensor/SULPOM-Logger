...
extension UIDevice {
    /// Get the current UIDevice's model type/info.
    /// Partial rip of https://github.com/devicekit/DeviceKit/blob/af953dafc2f9e22ad92c607cc7d8ae4a65cce695/Source/Device.generated.swift
    public enum Model: CustomStringConvertible {
      #if os(iOS)
      ...
      public static var current: Model {
        return Model.mapToDevice(identifier: Model.identifier)
      }
      ...
      public static func mapToDevice(identifier: String) -> Model { // swiftlint:disable:this cyclomatic_complexity function_body_length
        #if os(iOS)
          switch identifier {
